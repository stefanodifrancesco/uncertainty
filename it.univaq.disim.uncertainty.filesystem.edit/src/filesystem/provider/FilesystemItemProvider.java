...
import filesystem.filesystem_uncertainty.provider.aFilesystemItemProvider;
 ...
 * @generated
 */
public class FilesystemItemProvider extends aFilesystemItemProvider {
	/**
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.FILESYSTEM__DRIVES,
				 Filesystem_uncertaintyFactory.eINSTANCE.createaDrive()));

		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.FILESYSTEM__DRIVES,
				 Filesystem_uncertaintyFactory.eINSTANCE.createuDrive()));
		...
		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.FILESYSTEM__SYNCS,
				 Filesystem_uncertaintyFactory.eINSTANCE.createaSync()));
