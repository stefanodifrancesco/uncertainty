	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FilesystemPackage.FILESYSTEM: {
				...
				if (result == null) result = caseaFilesystem(filesystem);
			...
			case FilesystemPackage.DRIVE: {
				...
				if (result == null) result = caseaDrive(drive);
				if (result == null) result = caseFile(drive);
				if (result == null) result = caseaFolder(drive);
				if (result == null) result = caseaFile(drive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesystemPackage.FOLDER: {
				...
				if (result == null) result = caseaFolder(folder);
				if (result == null) result = caseaFile(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesystemPackage.SHORTCUT: {
				...
				if (result == null) result = caseaShortcut(shortcut);
				if (result == null) result = caseaFile(shortcut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesystemPackage.SYNC: {
				...
				if (result == null) result = caseaSync(sync);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FilesystemPackage.FILE: {
				...
				if (result == null) result = caseaFile(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
