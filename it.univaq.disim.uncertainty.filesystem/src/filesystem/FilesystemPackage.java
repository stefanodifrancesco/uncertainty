...
public interface FilesystemPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://it.univaq.disim/uncertainty.filesystem";
	 ...
	 * @ordered
	 */
	int FILESYSTEM__DRIVES = Filesystem_uncertaintyPackage.AFILESYSTEM_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FILESYSTEM__SYNCS = Filesystem_uncertaintyPackage.AFILESYSTEM_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FILESYSTEM_FEATURE_COUNT = Filesystem_uncertaintyPackage.AFILESYSTEM_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FILESYSTEM_OPERATION_COUNT = Filesystem_uncertaintyPackage.AFILESYSTEM_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FILE__NAME = Filesystem_uncertaintyPackage.AFILE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FILE_FEATURE_COUNT = Filesystem_uncertaintyPackage.AFILE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FILE_OPERATION_COUNT = Filesystem_uncertaintyPackage.AFILE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYNC__SOURCE = Filesystem_uncertaintyPackage.ASYNC_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SYNC__TARGET = Filesystem_uncertaintyPackage.ASYNC_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SYNC_FEATURE_COUNT = Filesystem_uncertaintyPackage.ASYNC_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SYNC_OPERATION_COUNT = Filesystem_uncertaintyPackage.ASYNC_OPERATION_COUNT + 0;
