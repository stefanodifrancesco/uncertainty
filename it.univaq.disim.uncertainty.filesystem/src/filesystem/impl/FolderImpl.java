...
public class FolderImpl extends FileImpl implements Folder {
	 ...
	 * @ordered
	 */
	protected EList<aFile> contents;
	 ...
	 * @generated
	 */
	public EList<aFile> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<aFile>(aFile.class, this, FilesystemPackage.FOLDER__CONTENTS);
		}
		return contents;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FilesystemPackage.FOLDER__CONTENTS:
				getContents().clear();
				getContents().addAll((Collection<? extends aFile>)newValue);
				return;
		}
