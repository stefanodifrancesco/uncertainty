...
import filesystem.filesystem_uncertainty.impl.Filesystem_uncertaintyPackageImpl;
...
public class FilesystemPackageImpl extends EPackageImpl implements FilesystemPackage {
	...
	public static FilesystemPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Filesystem_uncertaintyPackage.eNS_URI);
		Filesystem_uncertaintyPackageImpl theFilesystem_uncertaintyPackage = (Filesystem_uncertaintyPackageImpl)(registeredPackage instanceof Filesystem_uncertaintyPackageImpl ? registeredPackage : Filesystem_uncertaintyPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		Filesystem_uncertaintyPackage theFilesystem_uncertaintyPackage = (Filesystem_uncertaintyPackage)EPackage.Registry.INSTANCE.getEPackage(Filesystem_uncertaintyPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theFilesystem_uncertaintyPackage);
		...
		filesystemEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaFilesystem());
		driveEClass.getESuperTypes().add(this.getFolder());
		driveEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaDrive());
		folderEClass.getESuperTypes().add(this.getFile());
		folderEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaFolder());
		shortcutEClass.getESuperTypes().add(this.getFile());
		shortcutEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaShortcut());
		syncEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaSync());
		fileEClass.getESuperTypes().add(theFilesystem_uncertaintyPackage.getaFile());

		// Initialize classes, features, and operations; add parameters
		initEClass(filesystemEClass, Filesystem.class, "Filesystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFilesystem_Drives(), theFilesystem_uncertaintyPackage.getaDrive(), null, "drives", null, 0, -1, Filesystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFilesystem_Syncs(), theFilesystem_uncertaintyPackage.getaSync(), null, "syncs", null, 0, -1, Filesystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(driveEClass, Drive.class, "Drive", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(folderEClass, Folder.class, "Folder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFolder_Contents(), theFilesystem_uncertaintyPackage.getaFile(), null, "contents", null, 0, -1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
