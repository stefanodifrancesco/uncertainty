...
public class FamilyImpl extends ModelElementImpl implements Family {
	 ...
	 * @generated
	 */
	public EList<Family> getLinks() {
		if (links == null) {
			links = new EObjectResolvingEList<Family>(Family.class, this, FamiliesPackage.FAMILY__LINKS);
		}
		return links;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FamiliesPackage.FAMILY__LINKS:
				getLinks().clear();
				getLinks().addAll((Collection<? extends Family>)newValue);
				return;
		}
