...
public class FamiliesPackageImpl extends EPackageImpl implements FamiliesPackage {
	...
	public static FamiliesPackage init() {
		...
		FamiliesPackageImpl theFamiliesPackage_1 = (FamiliesPackageImpl)(registeredPackage instanceof FamiliesPackageImpl ? registeredPackage : FamiliesPackage.eINSTANCE);

		// Create package meta-data objects
		theFamiliesPackage.createPackageContents();
		theUncertaintyPackage.createPackageContents();
		theFamiliesPackage_1.createPackageContents();

		// Initialize created meta-data
		theFamiliesPackage.initializePackageContents();
		theUncertaintyPackage.initializePackageContents();
		theFamiliesPackage_1.initializePackageContents();
	...
	public void initializePackageContents() {
		...
		FamiliesPackage theFamiliesPackage_1 = (FamiliesPackage)EPackage.Registry.INSTANCE.getEPackage(FamiliesPackage.eNS_URI);
		...
		initEReference(getFamily_Links(), theFamiliesPackage_1.getFamily(), null, "links", null, 0, -1, Family.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
